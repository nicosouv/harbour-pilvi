...
Page {
    ...
    property string folderId: "root"
    property string folderName: "Google Drive"
    ...
    SilicaListView {
            ...
            MenuItem {
                ...
                onClicked: {
                    ...
                    dialog.accepted.connect(function() {
                        driveApi.createFolder(dialog.value, folderId)
                    })
                }
            }
            MenuItem {
        ...
        header: PageHeader {
            title: folderName
            description: qsTr("%n file(s)", "", fileModel.count)
        }
        ...
        delegate: ListItem {
            ...
            menu: ContextMenu {
                ...
                MenuItem {
                    text: qsTr("Move")
                    onClicked: {
                        var picker = pageStack.push("../dialogs/FolderPickerPage.qml")
                        picker.folderSelected.connect(function(targetFolderId) {
                            driveApi.moveFile(fileId, targetFolderId)
                        })
                    }
                }
                MenuItem {
